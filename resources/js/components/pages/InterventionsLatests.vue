<template>
    <div class="interventions-latests">
        <div class="table_container">
            <h1 class="mb-3">
                Lista interventi conclusi negli ultimi 30 giorni
            </h1>
            <table class="table">
                <thead>
                    <tr>
            ...
            <div class="buttons d-flex justify-content-end">
                <a
                    href="/interventions/latests/export/json"
                    class="btn btn-success btn-sm"
                    >Export JSON</a
                >
                <a
                    href="/interventions/latests/export/csv"
